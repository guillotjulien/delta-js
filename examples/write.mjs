...
// Note: doing that, arrow will interpret all numbers as float
...
await table.write(arrow.tableToIPC(data), "overwrite");
...
await table.write(arrow.tableToIPC(dataManual), "overwrite", "overwrite");
